...
<section class="hero">
  <div class="hero-text">
    <p class="kicker">UNSW Sydney · STREAM Research Group</p>
    <h1 class="hero-name">Lachlan Astfalck</h1>
    <p class="hero-role">Environmental statistics, spectral analysis, uncertainty
...
I'm a Lecturer in Statistics at the University of New South Wales and part of the STREAM Research Group. I have interest in both methodological and applied research. On the methods side: spectral analysis, complex spatio-temporal data, emulation of engineering
...
::: {.pubs}
HB Moss, **LC Astfalck**, T Cowperthwaite, C Doumont, S Willis, P Hennig et
al. (2026). 'Conditioning Gaussian Processes on Almost Anything'. Submitted to
*NeurIPS 2026*. [preprint](https://arxiv.org/abs/2605.21041)
...
inference for time series via divide-and-conquer'. Accepted (2026), in press,
*Journal of the American Statistical Association*.
[preprint](https://arxiv.org/pdf/2106.11043)
:::

```{=html}
<a class="btn-text" href="publications.html">All publications
